...
import browsing_history.pages.page.PageImpl;
import browsing_history.pages.position.Position;
import browsing_history.pages.position.PositionFactory;
import browsing_history.pages.position.text.TextAdvFactory;
import browsing_history.pages.position.video.VideoAdvFactory;
...
public class RawPageData {
    ...
    public Set<Page> convert() {
        ...
        for (Entry entry : pages) {
            ...
            initPositions((PositionFactory) new VideoAdvFactory(), entry.getVideoAdv(), converted, page);
            initPositions((PositionFactory) new TextAdvFactory(), entry.getTextAdv(), converted, page);
        }
        return converted;
    }
